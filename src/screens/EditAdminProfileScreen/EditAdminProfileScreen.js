...
const EditAdminProfileScreen = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // const response = await axios.patch('http://192.168.1.91:8080/admin/profile/update', updates, {
      //   headers: {
      ...
      //   await AsyncStorage.setItem('adminProfile', JSON.stringify(updatedUser));
